...
// Get all products
try {
    $stmt = $pdo->query("SELECT id, name_en, category, status FROM products ORDER BY category, name_en");
...
<head>
    ...
    <title>Products Manager - Success Microfinance Institution S.C.</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="products.php" class="list-group-item list-group-item-action bg-transparent second-text active">
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Products Manager</h2>
                </div>
            ...
            <div class="container-fluid px-4">
                <div class="row my-3">
                    <div class="col">
                        <a href="products-edit.php" class="btn btn-primary">
                                        ...
                                        <?php if(isset($products) && count($products) > 0): ?>
                                            <?php foreach($products as $product): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if($product['category'] == 'savings'): ?>
                                                            <span class="badge bg-info">Savings</span>
                                                        <?php elseif($product['category'] == 'loans'): ?>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="products-delete.php?id=<?php echo $product['id']; ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this product?');">
